...
{
    @try {
    NSArray *aImageUrls =[_dataSource arrayWithImageUrlStrings];
        
        NSLog(@"loadData setImageWithURL %@",aImageUrls);
    ...
    if([aImageUrls count] > 0)
    {
        ...
        _pageControl.hidden = ([(NSArray *)[_dataSource arrayWithImageUrlStrings] count] > 1?NO:YES);
...
- (void) initializePageControl
{
    ...
    _pageControl.center = CGPointMake(_scrollView.frame.size.width/2, _scrollView.frame.size.height - 50);
